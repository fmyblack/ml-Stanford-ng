...
for i = 1:m,
	...
	yi(y(i)) = 1;
	J = J + ( -yi * log(a_3) - (1 - yi) * log(1 - a_3));
	delta_3 = a_3 - yi';
	delta_2_tmp = Theta2' * delta_3;
	delta_2 = delta_2_tmp(2:end) .* sigmoidGradient(z_2);
...
J = J + lambda * (sum(sum(Theta1_t .^ 2)) + sum(sum(Theta2_t .^ 2))) / 2;
